...
ARG JENKINS_VERSION
ENV JENKINS_VERSION ${JENKINS_VERSION:-2.256}

# jenkins.war checksum, download will be validated using it
ARG JENKINS_SHA=ac59d1acca37baf9e42e9599ce654d18b0810a1643a71ff4ac9e6153a9a1a4b8
...
COPY resources/tini-shim.sh /bin/tini
COPY resources/jenkins-plugin-cli.sh /bin/jenkins-plugin-cli
